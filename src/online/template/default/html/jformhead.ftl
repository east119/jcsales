						...
						<#elseif po.show_type=='image'>
							...
							<#elseif po.show_type=='tree'>
								...
								<script>
									...
									<#-- update-begin-author:taoYan date:20180326 for:勾选 checkbox 对于父子节点的关联关系，需要根据特定的业务配置 -->
											check: {  
								                enable: true,
								                chkStyle: "checkbox",
												chkboxType: { "Y": "", "N": "" }
									        }, 
								    <#-- update-end-author:taoYan date:20180326 for:勾选 checkbox 对于父子节点的关联关系，需要根据特定的业务配置 -->
										    view: {  
										...
										<#-- update-begin-author:taoyan date:20180326 for:树选中/取消事件-取值，之前的代码逻辑判断太多，通用性不够好，此法虽非最优解但通用性强  -->
										 ...
										 <#-- update-end-author:taoyan date:20180326 for:树选中/取消事件-取值，之前的代码逻辑判断太多，通用性不够好，此法虽非最优解但通用性强  -->
										    e.stopPropagation();
										}  
