 ...
 */
@Entity
@Table(name = "jcfc_person", schema = "")
@SuppressWarnings("serial")
public class JcfcPersonEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="YWBM",nullable=false,length=32)
	...
	@Column(name ="YWMC",nullable=false,length=32)
    ...
    private List<JcfcPersonEntity> jcfcPersonList ;
	
    @Transient
	public List<JcfcPersonEntity> getJcfcPersonList() {
		return jcfcPersonList;
	}

	public void setJcfcPersonList(List<JcfcPersonEntity> jcfcPersonList) {
		this.jcfcPersonList = jcfcPersonList;
	}
}
