...
public enum OnlineGenerateEnum {
	...
	//update-begin--Author:zhangliang  Date:20170630 for：TASK #2039 【代码生成器改进】代码生成，不支持行编辑模式
	ONLINE_ROW_SINGLE("rowedit.single","行编辑风格表单","single","ext"),
	//update-end--Author:zhangliang   Date:20170630 for：TASK #2039 【代码生成器改进】代码生成，不支持行编辑模式
	//update-begin--Author:Yandong   Date:20180102 for：TASK #2234 【online样式】Online 一对多代码生成器新模板，全tab风格
	ONLINE_TAB_ONETOMANY("tab.onetomany","TAB风格表单","onetomany","ext");
	//update-end--Author:Yandong   Date:20180102 for：TASK #2234 【online样式】Online 一对多代码生成器新模板，全tab风格
