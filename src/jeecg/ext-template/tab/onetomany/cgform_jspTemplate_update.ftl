		...
		<div class="col-xs-2">
		   ...
		   <#elseif po.showType=='file' || po.showType == 'image'>
			...
			<#elseif po.showType=='tree'>
				...
				<#-- update-begin-author:taoyan date:20180326 for:样式bug,树控件默认值 -->
				...
				<#-- update-end-author:taoyan date:20180326 for:样式bug，树控件默认值 -->
					...
					function show${po.fieldName?cap_first }Tree(){
						 $.ajax({  
							...
							success:function(res){
								...
								<#-- update-end-author:taoyan date:20180326 for:树控件定位bug  -->
