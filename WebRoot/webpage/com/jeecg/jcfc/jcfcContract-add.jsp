...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jcfcContractController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="xxmc" name="xxmc" type="text" maxlength="255" style="width: 150px" class="inputxt"  datatype="*" ignore="checked" />
					...
					<td class="value">
					     	 <input id="ywjl" name="ywjl" type="text" maxlength="10" style="width: 150px" class="inputxt"  datatype="*" ignore="checked" />
							<span class="Validform_checktip"></span>
